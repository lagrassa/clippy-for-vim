...
cdef class PR2:
    ...
    cpdef fingerSupportFrame(self, hand, width):
        ...
        # closing direction and the y axis to point towrds the wrist.
        ...
        # print mat
        # raw_input('Is that right?')
        return util.Transform(mat)
    ...
    # attach object to gripper links, object expressed relative to gripper
